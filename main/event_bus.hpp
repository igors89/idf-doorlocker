...
enum class EventId : int32_t {
    ...
    NET_TESTFAILTRY,NET_TESTFAILREVERT,NET_SUSPCLIENT,NET_RTCSYNCED,NET_RTCDEVREQUEST,NET_RTCDEVSUPLY,NET_RTCNOSYNCED,
    RTC_READY,
    ...
    MQT_READY,
    MTT_READY,
    STO_READY,STO_SSIDOK,STO_QUERY,STO_UPDATE,STO_CONFIGSAVED,STO_CREDENTIALSAVED,STO_DEVICESAVED,STO_SENSORSAVED,
    BLE_READY
};
